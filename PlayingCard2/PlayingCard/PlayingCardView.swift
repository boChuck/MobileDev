...
//  PlayingCard
//
//  Created by ChuckLiu on 2/03/21.
//
...
//        path.fill()
        ...
        if isFaceUp{
            ...
            if let cardBackImage = UIImage(named: "purple_back"){
...
extension CGRect{
    ...
    let newHeigh = height * scale
        return insetBy(dx: (width-newWidth)/2, dy: (height-newHeigh)/2)
    }
}
